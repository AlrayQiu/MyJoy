...
HID_DESCRIPTOR G_DefaultHidDescriptor = {0x09,   // length of HID descriptor
...
--*/
{
    ...
    case IOCTL_HID_GET_REPORT_DESCRIPTOR: // METHOD_NEITHER
        ...
        //
        status = RequestCopyFromBuffer(
            Request, deviceContext->ReportDescriptor, deviceContext->HidDescriptor.DescriptorList[0].wReportLength);
        break;
